...
public class MainActivity extends AppCompatActivity implements
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            int signalStrength = intent.getIntExtra(LocationUpdatesService.EXTRA_SIGNAL_STRENGTH, 0);
            if (location != null) {
                Toast.makeText(MainActivity.this, Utils.getLocationText(location) + ", " + Integer.toString(signalStrength),
